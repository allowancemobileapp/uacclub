...
const formSchema = z.object({
  ...
  childAge: z.coerce.number().min(5, { message: 'Child must be at least 5 years old.' }).max(18, { message: 'Child must be at most 18 years old.' }),
  preferredSports: z.string().min(3, { message: 'Please list at least one preferred sport.' }),
});
...
export function SportsClubForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const message = `
*New UAC Sports Club Registration*
...
Age: ${values.childAge}
Preferred Sports: ${values.preferredSports}
    `;
    ...
    toast({
      ...
      description: 'Please send the pre-filled message to complete your registration.',
    });
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="e.g., Football, Basketball, Chess" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
